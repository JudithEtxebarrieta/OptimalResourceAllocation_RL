...
'''
from libraries.stablebaselines3 import Options
...
eval_output1,_,_=Options.eval_policy('policy_output',env,seed,10,library_dir+'/execution1')
eval_output2,_,_=Options.eval_policy('policy_output',env,seed,10,library_dir+'/execution1')
...
eval_policy0,_,_=Options.eval_policy('policy'+'0',env,seed,10,library_dir+'/execution1/process_info')
eval_policy1,_,_=Options.eval_policy('policy'+'1',env,seed,10,library_dir+'/execution1/process_info')
eval_policy2,_,_=Options.eval_policy('policy'+'2',env,seed,10,library_dir+'/execution1/process_info')
eval_policy3,_,_=Options.eval_policy('policy'+'3',env,seed,10,library_dir+'/execution1/process_info')
eval_policy4,_,_=Options.eval_policy('policy'+'4',env,seed,10,library_dir+'/execution1/process_info')
...
Options.learn_process(method,env,seed,total_timesteps,'execution4',library_dir,callback=True)
Options.learn_process(method,env,seed,total_timesteps,'execution5',library_dir,callback=True,deterministic_eval=True)

# El EvalCallback afecta en la secuencia de politicas, i.e., modifica la actualizacion de politicas por defecto? NO
equal_seq=True
for i in range(10):
    eval_policy1,_,_=Options.eval_policy('policy'+str(i),env,seed,5,library_dir+'/execution3/process_info')
    eval_policy2,_,_=Options.eval_policy('policy'+str(i),env,seed,5,library_dir+'/execution4/process_info')
...
all_ep_reward1,_,_=Options.eval_policy('policy3',env,seed,5,library_dir+'/execution5/process_info')
all_ep_reward2,_,_=Options.eval_policy('policy8',env,seed,5,library_dir+'/execution5/process_info')
...
all_ep_reward3,_,_=Options.eval_policy('best_model',env,seed,5,library_dir+'/execution5')
